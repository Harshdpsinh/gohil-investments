...
function StatCard({ icon, label, value, color = 'blue', onClick, badge }) {
  ...
  return (
    <div className={`stat-card group relative ${onClick ? 'cursor-pointer' : ''}`} onClick={onClick}>
      ...
      <div className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-lg border border-blue-200 bg-blue-50 dark:border-blue-900 dark:bg-blue-950/40 ${colors[color] || colors.blue}`}>
              ...
              return (
                <div key={p.id} className="flex items-center justify-between bg-red-50 dark:bg-red-900/20 rounded-lg px-3 py-2">
                  ...
                  <div className="text-right flex flex-col items-end gap-1">
                    <p className="text-sm font-bold text-orange-600">{d === 0 ? 'Today' : `${d}d`}</p>
